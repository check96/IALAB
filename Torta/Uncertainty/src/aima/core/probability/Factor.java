...
public interface Factor {
	...
	/**
	 * Max out the provided variables from this Factor creating a new Factor of
	 * the remaining variables with their values updated with the maxed out
	 * random variables.<br>
	 * <br>
	 * see: AIMA3e page 527.<br>
	 * <br>
	 *
	 * @param combinations
	 * 	          list of assignments of the previous maxed out variables.
	 * @param var
	 *            the random variable to max out.
	 *
	 * @return a new Factor containing any remaining random variables not maxed
	 *         out and a new set of values updated with the maxed out values.
	 */
	Factor maxOut(Record combinations, RandomVariable var);
